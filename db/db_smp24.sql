...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Des 2020 pada 10.40
...
INSERT INTO `album` (`album_id`, `album_nama`) VALUES
(6, 'HUT PGRI'),
...
INSERT INTO `galeri` (`id_galeri`, `album_id`, `nama_galeri`, `foto`) VALUES
(53, 6, 'Keterangan', 'IMG20181126101325.jpg'),
(54, 6, '', 'IMG20181126101601.jpg'),
(55, 6, '', 'IMG20181126102215.jpg'),
(56, 7, '', '41392299_260098504641894_8771935145213829503_n.jpg'),
(57, 7, '', 'IMG-20190306-WA0004.jpg'),
(58, 7, '', 'IMG20180907075432.jpg'),
(59, 7, '', 'IMG20181003073938.jpg'),
(60, 7, '', 'IMG20181123074313.jpg'),
(61, 6, '', 'IMG20181126101325.jpg'),
(62, 6, '', 'IMG20181126101601.jpg'),
(63, 6, '', 'IMG20181126102215.jpg'),
(64, 6, '', 'IMG20181126101325.jpg'),
(65, 6, '', 'IMG20181126101601.jpg');
...
--
-- Struktur dari tabel `osim`
--

CREATE TABLE `osim` (
  `osim_id` int(11) NOT NULL,
  `osim_judul` varchar(500) NOT NULL,
  `osim_tgl` date NOT NULL,
  `osim_isi` text NOT NULL,
  `osim_gambar` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `osim`
--

INSERT INTO `osim` (`osim_id`, `osim_judul`, `osim_tgl`, `osim_isi`, `osim_gambar`) VALUES
(2, 'LL DIKTI Wilayah X adakan Wasdalbin tingkatkan mutu PTS', '2020-11-24', '<p>Lembaga Layanan Pendidikan Tinggi (LL DIKTI) Wilayah X mengadakan Pengawasan, Pengendalian, dan Pembinaan (Wasdalbin) 2020 dalam rangka meningkatkan mutu penyelenggaraan Perguruan Tinggi Swasta (PTS).<br />\r\n<br />\r\n&quot;Pelaksanaan Wasdalbin ini bertujuan untuk meningkatkan mutu PTS di lingkungan LL DIKTI Wilayah X, yakni Jambi, Sumbar, Riau, dan Kepulauan Riau,&quot; kata Kepala LL DIKTI Wilayah X Prof Herri di Padang, Senin.<br />\r\n<br />\r\nIa mengatakan pelaksanaan Wasdalbin 2020 ditujukan kepada PTS penyelenggara program profesi, program magister, dan program doktor yang akan dilaksanakan pada November hingga Desember 2020.<br />\r\n<br />\r\n&quot;Jadwal pastinya tim yang ditunjuk akan menginformasikan terlebih dahulu sebelum pelaksanaan Wasdalbin,&quot; kata dia.<br />\r\n<br />\r\nIa juga mengatakan tujuan pelaksanaan Wasdalbin ini untuk memastikan pelaksanaan praktek pengajaran, penelitian, dan pengabdian masyarakat sesuai standar yang sudah ditetapkan.<br />\r\n<br />\r\nSelain itu, untuk kelancaran pelaksanaan Wasdalbin tersebut, ia meminta kehadiran pimpinan PTS, ketua prodi pascasarjana dan program profesi, ketua SPMI, dan Operator.<br />\r\n<br />\r\n&quot;Instrumen Wasdalbin sudah diisi sebelum tim mengunjungi PTS,&quot; ujar dia.<br />\r\n<br />\r\nIa berharap PTS agar menyiapkan dokumen pendukung sesuai dengan petunjuk instrumen Wasdalbin. Instrumen Wasdalbin akan diupload pada website LL DIKTI Wilayah X.<br />\r\n<br />\r\n&quot;Pelaksanaan Wasdalbin dibiayai melalui DIPA LL DIKTI Wilayah X tahun 2020,&quot; ujar dia.</p>\r\n', '2020112411410023herri.jpg'),
(3, 'Kembali ke zona kuning, sekolah tatap muka di Payakumbuh dilaksanakan Rabu pekan ini', '2020-11-24', '<p>Setelah ditetapkan kembali sebagai daerah zona kuning atau daerah dengan zona penyebaran rendah, Pemerintah Kota (Pemkot) Payakumbuh, Sumatera Barat berencana akan kembali melaksanakan pembelajaran tatap muka di sekolah.<br />\r\n<br />\r\nKepala Dinas Pendidikan Kota Payakumbuh, Agustion di Payakumbuh, Senin, mengatakan dalam rangka persiapan pelaksanaan pembelajaran tatap muka, pihaknya telah melakukan pertemuan dengan kepala sekolah di daerah itu.<br />\r\n<br />\r\n&quot;Saat ini kami terus berkoordinasi dengan tim gugus tugas COVID-19 Kota Payakumbuh terkait rencana pembelajaran tatap muka akan dilaksanakan kembali pada Rabu (25/11),&quot; ujarnya.<br />\r\n<br />\r\nIa menjelaskan untuk PAUD dan SD kelas rendah atau kelas 1, 2, dan 3 juga sudah diizinkan masuk tapi dengan frekuensi jam belajar yang lebih sedikit dibandingkan dengan kelas tinggi.<br />\r\n<br />\r\nSementara siswa kelas 4 hingga 6 SD, SMP, dan SMA belajar dengan jadwal diatur sekolah dengan aturan satu kelas sekali masuk hanya diisi 50 persen dari total siswa di dalam satu kelas.<br />\r\n<br />\r\n&quot;Masuk sekolah di tengah pandemi ini, proses belajar mengajarnya dikombinasikan antara tatap muka dan daring, artinya tidak seluruh anak masuk sekolah sekaligus. Beberapa siswa belajar daring dari rumah disaat kelas lain belajar di sekolah secara tatap muka,&quot; ujarnya.<br />\r\n<br />\r\nIa mengatakan diperbolehkannya sekolah tatap muka ini juga mengacu kepada tingkat SMA sederajat karena memang mengacu kepada rekomendasi Ketua Tim Gugus Tugas Kota Payakumbuh.<br />\r\n<br />\r\nMenurutnya, sejauh ini setiap sekolah di Payakumbuh sudah siap untuk menjalankan protokol kesehatan saat sekolah sudah dibuka kembali.<br />\r\n<br />\r\n&quot;Malahan disaat rencana kita yang beberapa kali gagal sekolah tatap muka dulu, sekolah-sekolah sudah jauh hari mempersiapkan sarana protokol kesehatan bagi siswanya,&quot; ujarnya.<br />\r\n<br />\r\nSementara anggota DPRD Kota Payakumbuh, YB Dt. Parmato Alam mendukung rencana kembali dilaksanakannya sekolah tatap muka di Kota Payakumbuh selama dapat dipastikan protokol kesehatan dijalankan dengan ketat.<br />\r\n<br />\r\n&quot;Memang aspirasi di masyarakat tentang ini ada pro dan ada kontra. Namun, secara pembelajaran, jika terus dilaksanakan daring akan berdampak kepada anak itu sendiri,&quot; kata dia.<br />\r\n<br />\r\nIa mengatakan suksesnya pembelajaran tatap muka di Payakumbuh tidak akan terlepas dari kerjasama antara tim penegak protokol kesehatan, tim kesehatan, pihak sekolah dan orang tua.<br />\r\n<br />\r\n&quot;Ini yang penting, tidak ada jalan sendiri-sendiri. Terus berkoordinasi dan saling mendukung. Ini sudah waktunya untuk kembali pelaksanaan sekolah tatap muka,&quot; ujarnya.</p>\r\n', '2020112411420323pendidikan.jpg'),
(4, 'Pemkot Pariaman pastikan belajar tatap muka di sekolah penerapan protokol kesehatan', '2020-11-24', '<p>Pemerintah Kota (Pemkot) Pariaman, Sumatera Barat akan terus memantau perkembangan berlajar tatap muka di sekolah untuk memastikan penerapan protokol kesehatan.<br />\r\n<br />\r\n&quot;Alhamdulillah hingga saat ini pihak sekolah dan siswa masih menerapkan protokol kesehatan. Dan anak-anak terlihat senang mengikuti belajar di sekolah,&quot; kata Pelaksana Tugas Walikota Pariaman, Mardison Mahyuddin di Pariaman, Senin.<br />\r\n<br />\r\nIa mengatakan diterapkannya belajar tatap muka di sekolah karena daerah itu masuk ke dalam zona kuning penyebaran COVID-19.<br />\r\n<br />\r\nNamun dalam pelaksanaannya Pemkot Pariaman menerapkan protokol kesehatan dengan ketat.<br />\r\n<br />\r\nIa menegaskan siapa pun yang datang ke sekolah di Pariaman harus menerapkan protokol kesehatan mulai dari mencuci tangan dengan sabun, pemeriksaan suhu tubuh, menggunakan masker, dan menjaga jarak.<br />\r\n<br />\r\n&quot;Ini akan kami pantau melalui Satgas COVID-19, mudah-mudahan tidak ada klaster penyebaran COVID-19 dari sekolah,&quot; katanya.<br />\r\n<br />\r\nIa menyampaikan mekanisme pembelajaran dalam belajar tatap muka tersebut yaitu siswa yang hadir hanya 50 persen dari daya tampung lokal, tidak ada jam istirahat, siswa makan di rumah, dan selesai belajar langsung pulang.<br />\r\n<br />\r\n&quot;Jadi siswa yang datang ke sekolah dari Senin sampai Rabu itu setengah dari daya tampung lokal, sedangkan setengah lagi datang ke sekolah Kamis, Jumat, dan Sabtu,&quot; ujarnya.<br />\r\n<br />\r\nIa berharap dengan belajar tatap muka di sekolah tersebut maka siswa di daerah itu bergairah kembali belajar karena dalam beberapa bulan terakhir belajar di rumah dan tidak bertemu dengan teman-temannya.<br />\r\n<br />\r\nSebelumnya Pariaman kembali menerapkan belajar tatap muka di sekolah setelah daerah itu dinyatakan masuk ke dalam zona kuning penyebaran COVID-19.<br />\r\n<br />\r\n&quot;Pariaman sekarang masuk ke dalam zona kuning sehingga berpeluang diselenggarakan belajar tatap muka,&quot; kata Kepala Dinas Pendidikan Pemuda dan Olahraga Kota Pariaman, Kanderi.<br />\r\n<br />\r\nIa mengatakan sistem penerapan belajar tatap muka tersebut yaitu dengan menerapkan protokol kesehatan mulai dari pemeriksaan suhu, penggunaan masker, dan jaga jarak serta jumlah siswa yang hadir setengah dari kapasitas ruangan.<br />\r\n<br />\r\nSelain itu, lanjutnya proses belajar dimulai dari sekitar pukul 07.30 WIB hingga sekitar pukul 10.00 WIB dan tidak ada jam istirahat atau siswa langsung dapat pulang.</p>\r\n', '2020112411424123belajar.jpg'),
(5, 'Polemik sekolah kembali dibuka, ini kata pengamat UNP', '2020-11-24', '<p>Pengamat pendidikan dari Universitas Negeri Padang Dr. Fitri Arsih berpandangan, saat ini disiplin protokol kesehatan belum menjadi kebiasaan masyarakat, bila dipaksakan proses belajar mengajar dengan tatap muka sangat besar berpeluang menciptakan cluster baru, yaitu cluster sekolah.<br />\r\n<br />\r\n&ldquo;Jangan pertaruhkan masa depan anak untuk kegiatan belajar tatap muka di sekolah. Jangan jadikan alasan sekolah kembali dibuka karena Kota Padang telah keluar dari zona merah. Sangat berisiko sekali dan amat disesalkan jika ini terjadi,&rdquo; tegas Fitri Arsih dosen yang mengajar di Fakultas Matematika dan Ilmu Pengetahuan Alam (FMIPA) UNP, di Padang, Sabtu.<br />\r\n<br />\r\nMenurut dia, bahwa yang menjadi permasalahan pada saat pendidikan secara daring ini adalah keterbatasan kemampuan orang tua dalam mengawasi dan membantu pembelajaran terhadap siswa di rumah.<br />\r\n<br />\r\nLebih lanjut, untuk menciptakan pendidikan daring yang menarik, guru dan orang tua harus membangun kolaborasi demi memaksimalkan proses belajar jarak jauh.<br />\r\n<br />\r\n&ldquo;Kreativitas guru dalam menghadirkan pembelajaran daring yang menarik dan menyenangkan akan sangat menentukan besarnya atensi siswa terhadap kegiatan belajar daring tersebut. Sedangkan pendampingan dan keaktifan orang tua dalam menemani anak akan menentukan sejauh mana kegiatan belajar di rumah akan bermanfaat dan bermakna,&rdquo; tutupnya.<br />\r\n<br />\r\nDi tempat terpisah Sosiolog UNP Dr. Erianjoni, menyatakan perlu sebuah evaluasi tentang kelayakan sekolah akan dibuka, sehingga tidak terjadi nanti sekolah sebagai kluster pandemi COVID-19.<br />\r\n<br />\r\n&quot;Selain itu harus ada sebuah komitmen bersama agar jangan ada saling menyalahkan antar berbagai pihak di kemudian hari,&quot; tambahnya.</p>\r\n', '20201124114309IMG-20201121-WA0073.jpg');
...
INSERT INTO `pengumuman` (`id_pengumuman`, `judul_pengumuman`, `tgl_post`, `isi_pengumuman`, `foto_pengumuman`) VALUES
(2, 'Bawaslu Pariaman maksimalkan peran pemuda awasi Pilgub Sumbar', '2018-12-11', '<p>Pariaman (ANTARA) - Badan Pengawas Pemilihan Umum (Bawaslu) Kota Pariaman, Sumatera Barat (Sumbar) memaksimalkan peran pemuda di daerah itu untuk mengawasi pelaksanaan pemilihan gubernur (Pilgub) dan wakil gubernur (wagub) provinsi ini.<br />\r\n<br />\r\n&quot;Kita mengetahui pemuda memiliki semangat yang tinggi dan ide-ide dari mereka perlu untuk peningkatan pengawasan Pilkada,&quot; kata Ketua Bawaslu Kota Pariaman, Riswan usai penandatanganan Nota Kesepahaman antara Bawaslu Pariaman dengan Komite Nasional Pemuda Indonesia (KNPI) dan Karang Taruna di Pariaman, Kamis.<br />\r\n<br />\r\nApalagi, kata dia pemuda memiliki organisasi diantaranya KNPI dan Karang Taruna yang memiliki struktur pengurusan hingga ke desa dan keluruhan.<br />\r\n<br />\r\nIa mengatakan dengan kegiatan yang dilakukan pihaknya bersama organisasi kepemudaan tersebut maka diharapkan dapat menutupi kekurangan Bawaslu dalam hal pengawasan dan sosialisasi Pilgub dan wagub Sumbar.<br />\r\n<br />\r\n&quot;Tidak semua pemilih yang dapat kami jangkau sehingga organisasi ini dan pihak lainnya kami harapkan dapat membantu kami dalam hal sosialisasi dan pengawasan,&quot; katanya.<br />\r\n<br />\r\nPihaknya berharap dengan keterlibatan pemuda dan pihak lainnya dapat membantu meningkatkan partisipasi pemilih serta memberikan sosialisasi kepada warga agar menerapkan protokol kesehatan.<br />\r\n<br />\r\nSementara itu Ketua Karang Taruna Kota Pariaman, Afdila mengatakan dengan penandatanganan nota kesepahaman tersebut maka pihaknya merasa terpanggil untuk ikut berpartisipasi dalam pengawasan Pilgub.<br />\r\n<br />\r\n&quot;Kami pun mengajak pemuda untuk ikut berpartisipasi dalam hal pengawasan dan mengajak warga untuk memilih pada hari pemilihan,&quot; ujarnya.<br />\r\n<br />\r\nKetua KNPI Kota Pariaman, Febrian Mirdani mengatakan sebelumnya pemuda hanya dijadikan sebagai alat untuk kepentingan politik namun sekarang dijadikan bagian penting dalam pelaksanaan pesta demokrasi.<br />\r\n<br />\r\n&quot;Kami merasa tertantang dalam pelaksanaannya dan kami pun komitmen untuk menjalankan,&quot; kata dia.<br />\r\n<br />\r\nTerpisah mantan Ketua KNPI Kota Pariaman periode 2012-2015 Riky Falantino mengatakan peringatan Hari Pahlawan dapat menjadi momentum bagi pemuda untuk mengambil peran dalam mengawasi proses demokrasi.<br />\r\n<br />\r\n&quot;Pemuda adalah pahlawan demokrasi, pemuda hari ini &quot;zaman now&quot; atau generasi milenial harus mengambil peran dalam mensukseskan dan mengawal Pilgub dan Wagub Sumbar 2020, jadi jangan hanya menjadi objek,&quot; ujar dia.<br />\r\n<br />\r\nIa mengatakan pemuda dapat mengambil peran dengan membuat kegiatan-kegiatan produktif dan edukatif bersama pemerintah desa dan kelurahan serta tokoh adat setempat untuk membicarakan terkait Pilgub dan Wagub Sumbar.<br />\r\n<br />\r\nIa menyebutkan pada kegiatan tersebut dapat dibahas terkait pentingnya menggunakan hak pilih meski di tengah pandemi karena dalam pelaksanaan pemilihan menerapkan protokol kesehatan.<br />\r\n&nbsp;</p>\r\n', ''),
(8, '27 Anggota Polres Pariaman Positif COVID-19', '2020-11-14', '<p>Sebanyak 27 personel Kepolisian Resor Kota&nbsp;<a href=\"https://www.detik.com/tag/pariaman\">Pariaman</a>, Sumatera Barat (<a href=\"https://www.detik.com/tag/sumbar\">Sumbar</a>), dinyatakan positif COVID-19. Selain itu, ada 4 orang lainnya dari keluarga personel yang positif Corona.</p>\r\n\r\n<p>&nbsp;</p>\r\n', ''),
(10, 'Kapal Wisata Terbalik di Pariaman Sumbar, 1 Tewas', '2020-11-14', '<p>Kapal wisata yang membawa rombongan guru terbalik di&nbsp;<a href=\"https://www.detik.com/tag/pariaman\">Pariaman</a>, Sumatera Barat. Satu orang meninggal dunia, sementara satu lainnya harus mendapat perawatan intensif di rumah sakit.<br />\r\n<br />\r\nKabid Kedaruratan dan Logistik BPBD Sumatera Barat, Rumainur menyebutkan, kapal naas itu dihantam gelombang dalam perjalanan dari Pantai Pariaman menuju Angso Duo, Sabtu (25/10/2019). Angso Duo merupakan pulau yang menjadi ikon wisata di daerah itu.</p>\r\n', ''),
(11, 'Ubur-ubur Bluebottle Serang Nelayan di Sumbar, Warga Diminta Waspada', '2020-11-14', '<p>Dua nelayan di Kota Pariaman, Sumatera Barat, dilarikan ke Rumah Sakit Umum Daerah (RSUD) karena diserang ubur-ubur jenis&nbsp;<em>bluebottle</em>. Akibat kejadian itu, warga setempat meminta para nelayan dan wisatawan berhati-hati ketika berada di laut.<br />\r\n<br />\r\n&quot;Salah satu korban adalah anak buah kapal (ABK) saya, kejadian sekitar 10 hari lalu. Seorang lagi Ali Imran (43), warga setempat, yang terjadi beberapa hari lalu,&quot; kata nakhoda kapal nelayan, Perizal (37), di Pariaman, yang dilansir dari&nbsp;<em>Antara</em>, Jumat (4/10/2019).<br />\r\n<br />\r\nIa mengatakan ABK tersebut tersengat ubur-ubur jenis&nbsp;<em>bluebottle</em>&nbsp;di wilayah Pulau Kasiak ketika mengangkat jaring di tengah laut. Namun dia juga melihat ubur-ubur itu mengapung di sepanjang perairan Pariaman.</p>\r\n', ''),
(14, 'Judul Artikel', '2020-12-23', '<p>sdsd</p>\r\n', '20201223120028IMG20181126101601.jpg'),
(15, 'Judul Pengumuman', '2020-12-23', '<p>Isi Pengumuman</p>\r\n', '20201223114626IMG20181126101325.jpg');
...
CREATE TABLE `ppid` (
  ...
  `ppid_menu` varchar(255) NOT NULL,
  `ppid_menu_seo` varchar(255) NOT NULL,
  `ppid_tipe` varchar(255) NOT NULL,
  `ppid_isi` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `profil` (
  ...
  `profil_menu` varchar(255) NOT NULL,
  `profil_menu_seo` varchar(255) NOT NULL,
  `profil_tipe` varchar(255) NOT NULL,
...
INSERT INTO `profil` (`profil_id`, `profil_menu`, `profil_menu_seo`, `profil_tipe`, `profil_isi`) VALUES
(1, 'Visi dan Misi', 'visi-dan-misi', 'teks', '<p style=\"margin-left:0in; margin-right:0in; text-align:center\"><span style=\"font-family:Times New Roman,Times,serif\"><span style=\"font-size:12.0pt\"><span style=\"font-size:22px\">Visi Sekolah</span></span></span></p>\r\n\r\n<p style=\"margin-left:0in; margin-right:0in; text-align:center\">&nbsp;</p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:14.0pt\"><span style=\"font-family:&quot;Cambria&quot;,&quot;serif&quot;\">Berkarakter, Berprestasi, Menguasai IPTEK d</span></span></span></span><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:14.0pt\"><span style=\"font-family:&quot;Cambria&quot;,&quot;serif&quot;\">an Berbudaya Lingkungan&nbsp;</span></span></span></span><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:14.0pt\"><span style=\"font-family:&quot;Cambria&quot;,&quot;serif&quot;\">yang dilandasi IMTAQ</span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><strong><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Penjelasan Visi</span></span></strong></span></span></p>\r\n\r\n<ol>\r\n	<li><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Peserta didik yang berkarakter adalah peserta didik yang memiliki sikap dan tingkah laku yang mencerminkan nilai-nilai yang terkandung dari setiap butir Pancasila.</span></span></span></span></li>\r\n	<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Berprestasi adalah semua warga sekolah berpacu meraih prestasi baik di bidang akademik, ekstrakurikuler dan bidang lainnya</span></span></span></span></li>\r\n	<li style=\"text-align:justify\"><span style=\"font-family:&quot;Times New Roman&quot;,serif; font-size:12pt\">Peserta didik yang menguasai IPTEK adalah peserta didik yang berpengetahuan,&nbsp;&nbsp; cekatan,</span><span style=\"font-family:Calibri, sans-serif\"><span style=\"font-size:14.6667px\">&nbsp;</span></span><span style=\"font-family:Calibri,sans-serif; font-size:12pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">cepat tanggap terhadap perkembangan ilmu pengetahuan dan tekhnologi.</span></span></li>\r\n	<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Peserta didik&nbsp; yang berwawsan lingkungan adalah peserta didik&nbsp; yang selalu hidup&nbsp;</span></span><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">bersih, sehat dan peduli terhadap lingkungan kehidupannya dan memiliki keimanan yang kuat serta mengamalkan ajaran agama yang dianut.</span></span></span></span></li>\r\n</ol>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\">&nbsp;</p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><strong><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Indikator Visi</span></span></strong><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\"> </span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">1. Mewujudkan peserta didik yang terampil dan menguasai IPTEK</span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">2. Mewujudkan peserta didik yang cerdas (IQ, EQ, SQ, KQ)</span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">3. Mewujudkan peserta didik yang beriman dan bertaqwa</span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">3. Mewujudkan peserta didik&nbsp; yang berbudaya lingkungan</span></span></span></span></p>\r\n\r\n<p style=\"margin-left:0in; margin-right:0in; text-align:center\">&nbsp;</p>\r\n\r\n<p style=\"margin-left:0in; margin-right:0in; text-align:center\"><span style=\"font-family:Times New Roman,Times,serif\"><span style=\"font-size:12.0pt\"><span style=\"font-size:22px\">Misi Sekolah&nbsp;</span></span></span></p>\r\n\r\n<p style=\"margin-left:0in; margin-right:0in; text-align:center\">&nbsp;</p>\r\n\r\n<ol>\r\n	<li style=\"list-style-type:none\">\r\n	<ol>\r\n		<li style=\"list-style-type:none\">\r\n		<ol>\r\n			<li style=\"list-style-type:none\">\r\n			<ol>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Menanamkan nilai-nilai agama dan akhlak mulia melalui pembelajaran dan pengalaman.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Melaksanakan pembelajaran berbasis pembangunan karakter bangsa. </span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Meningkatkan kompetensi pendidik dan tenaga kependidikan dalam mendorong terciptanya proses pembelajaran yang efektif dan berkarakter.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Melakukan proses pembelajaran kreatif dan inofatif dan menyenangkan berdasarkan standar proses.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Mengembangkan keterampilan, bakat dan minat warga sekolah untuk berprestasi baik kognitif maupun psykomotorik.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Menyiapkan siswa yang mengikiti event-event antar sekolah provinsi maupun nasional.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Melaksanakan pembelajaran berbasis tekhnologi dan komunikasi.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Melakukan kerjasama dengan lembaga, instansi atau institut yang lain yang mengikat dalam rangka mengembangkan kemampuan dan kemajuan sekolah.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Menanamkan nilai-nilai dan berwawasan lingkungan dan diimplementasi melalaui kegiatan peduli lingkunngan.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Membentuk siswa yang mampu mengolah sampah menjadi bermanfaat dan bernilai tinggi.</span></span></span></span></li>\r\n				<li style=\"text-align:justify\"><span style=\"font-size:11pt\"><span style=\"font-family:Calibri,sans-serif\"><span style=\"font-size:12.0pt\"><span style=\"font-family:&quot;Times New Roman&quot;,&quot;serif&quot;\">Membangun kepedulian dan kecintaan warga sekolah terhadap kebersihan, keindahan, asri dan nyaman.</span></span></span></span></li>\r\n			</ol>\r\n			</li>\r\n		</ol>\r\n		</li>\r\n	</ol>\r\n	</li>\r\n</ol>\r\n'),
(2, 'Profil Sekolah', 'profil-sekolah', 'berkas', '20201222165723-94619.pdf'),
(3, 'Sejarah', 'sejarah', 'teks', '<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:12pt\"><span style=\"font-family:&quot;Times New Roman&quot;,serif\">Sekolah Menengah Pertama Negeri 24 Padang ini berdiri pada tahun 1984, berlokasi di Jalan By Pass Lubuak Bagaluang, Kelurahan Lubuak Bagaluang, Kecamatan Lubuak Bagaluang Kota Padang. Sekolah ini yang berdiri di atas lahan seluas + 4.100 m2, dulunya adalah fialial dari SMPN 11 Padang.</span></span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:12pt\"><span style=\"font-family:&quot;Times New Roman&quot;,serif\">SMP Negeri 24 Padang, memiliki bangunan kelas yang berjumlah 24 ruang, dengan 8 rombongan belajar kelas VII (tujuh), 8 rombongan belajar kelas VIII (delapan), serta 8 rombongan belajar kelas IX (sembilan). Memiliki 1 Ruang Kantor Tata Usaha, 1 Ruang Kepala Sekolah, Laboratorium IPA, Perpustakaan, Laboratorium Komputer, Ruang KKG, Ruang Tabloid, Ruang Bank Sampah, Ruang Kesenian, Ruang Penyimpanan Alat-alat Pramuka, Ruang Olah Raga, Ruang OSIS, Ruang UKS, Ruang PIK-R, Koperasi Sekolah, Musholla, Ruang BP, Kantin, WC Siswa, WC Guru dan Lapangan Upacara.</span></span></p>\r\n'),
(4, 'Sarana', 'sarana', 'teks', '<p><br />\r\n&nbsp;&nbsp;&nbsp; 1.&nbsp; Class Room&nbsp; : Ruang kelas dengan jumlah siswa maksimal 35 orang<br />\r\n&nbsp;&nbsp;&nbsp; 2. Audio Video Presentation<br />\r\n&nbsp;&nbsp;&nbsp; 3. Labor Komputer<br />\r\n&nbsp;&nbsp;&nbsp; 4. Mushalla dan Tempat Wudhu&#39;<br />\r\n&nbsp;&nbsp;&nbsp; 5. Arena Bermain<br />\r\n&nbsp;&nbsp;&nbsp; 6. Library/Perpustakaan<br />\r\n&nbsp;&nbsp;&nbsp; 7. Transportasi Sekolah<br />\r\n&nbsp;&nbsp;&nbsp; 8. Kantin/Koperasi Sekolah<br />\r\n&nbsp;&nbsp;&nbsp; 9. Asuransi Siswa</p>\r\n\r\n<p>&nbsp;</p>\r\n'),
(5, 'Struktur', 'struktur', 'berkas', '20201222163241-42951.pdf');
...
INSERT INTO `slide` (`slide_id`, `slide_judul`, `slide_foto`) VALUES
(7, 'Slide 1', '20201223163116-46727.jpg'),
(8, 'Slide 2', '20201222121820-63741.jpeg'),
(9, 'Slide 3', '20201223163210-77562.jpeg'),
(10, 'slide-4', '20201223163247-97148.jpeg');
...
--
-- Struktur dari tabel `tb_ayah_siswa`
--

CREATE TABLE `tb_ayah_siswa` (
  ...
  `ayah_notelp` varchar(255) NOT NULL,
  `ayah_pekerjaan` varchar(255) NOT NULL,
  `ayah_gaji` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_ayah_siswa`
--

INSERT INTO `tb_ayah_siswa` (`ayah_id`, `user_id`, `ayah_nama`, `ayah_tempat_lahir`, `ayah_tgl_lahir`, `ayah_pendidikan`, `ayah_notelp`, `ayah_pekerjaan`, `ayah_gaji`) VALUES
(1, 1, 'fofo', 'padang', '1978-08-12', 'SMP Sederajat', '1231', 'Aparatur Negara (TNI, POLISI, PNS)', 'Rp.2.000.000 s/d Rp.4.000.000'),
(2, 2, 'Commodo aut quae cup', 'Veritatis ad ea quia', '1991-06-11', 'S3', 'Sint odit do molliti', 'Pegawai swasta', 'Kurang dari Rp.20.000.000');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_ibu_siswa`
--

CREATE TABLE `tb_ibu_siswa` (
  `ibu_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `ibu_nama` varchar(255) NOT NULL,
  `ibu_tempat_lahir` varchar(255) NOT NULL,
  `ibu_tgl_lahir` date NOT NULL,
  `ibu_pendidikan` varchar(255) NOT NULL,
  `ibu_notelp` varchar(255) NOT NULL,
  `ibu_pekerjaan` varchar(255) NOT NULL,
  `ibu_gaji` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_ibu_siswa`
--

INSERT INTO `tb_ibu_siswa` (`ibu_id`, `user_id`, `ibu_nama`, `ibu_tempat_lahir`, `ibu_tgl_lahir`, `ibu_pendidikan`, `ibu_notelp`, `ibu_pekerjaan`, `ibu_gaji`) VALUES
(1, 1, 'fifi', 'padang', '1980-10-21', 'SMP Sederajat', '123123', 'Wiraswasta', 'Rp.2.000.000 s/d Rp.4.000.000'),
(2, 2, 'Perspiciatis modi a', 'Nesciunt at exceptu', '1985-01-26', 'S3', 'Molestiae aliquip es', 'Tidak Bekerja', 'Rp.1.000.000 s/d Rp.2.000.000');
...
CREATE TABLE `tb_prestasi_siswa` (
  ...
  `user_id` int(11) NOT NULL,
  `prestasi_kategori` varchar(255) NOT NULL,
  `prestasi_juara` varchar(255) NOT NULL,
  `prestasi_deskripsi` text NOT NULL,
  `prestasi_sertifikat` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_prestasi_siswa`
--

INSERT INTO `tb_prestasi_siswa` (`prestasi_id`, `user_id`, `prestasi_kategori`, `prestasi_juara`, `prestasi_deskripsi`, `prestasi_sertifikat`) VALUES
(1, 1, '123', 'Juara 1', 'ok', '20201128102301-67188.jpg');
...
CREATE TABLE `tb_sekolah_asal` (
  `sekolah_asal_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `sekolah_asal_nama` varchar(255) NOT NULL,
  `sekolah_asal_npsp` varchar(255) NOT NULL,
  `sekolah_asal_nis` varchar(255) NOT NULL,
  `id_prov` int(11) NOT NULL,
  `id_kab` int(11) NOT NULL,
  `id_kec` int(11) NOT NULL,
  `id_kel` int(11) NOT NULL DEFAULT 0,
  `sekolah_asal_alamat` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `tb_sekolah_asal`
--

INSERT INTO `tb_sekolah_asal` (`sekolah_asal_id`, `user_id`, `sekolah_asal_nama`, `sekolah_asal_npsp`, `sekolah_asal_nis`, `id_prov`, `id_kab`, `id_kec`, `id_kel`, `sekolah_asal_alamat`) VALUES
(1, 1, 'SMP 1 Pariaman', '123123', '1231', 13, 1305, 130504, 0, 'ok'),
(2, 2, 'Nobis eiusmod dolore', 'Quod commodo consequ', 'Quia dolore dolores ', 62, 6202, 620202, 0, 'Do aut dicta enim qu');
...
CREATE TABLE `tb_siswa` (
  ...
  `siswa_nik` varchar(255) NOT NULL,
  `siswa_jekel` varchar(12) NOT NULL,
  `siswa_agama` varchar(255) NOT NULL,
  `siswa_tempat_lahir` text NOT NULL,
  `siswa_tgl_lahir` date NOT NULL,
  `siswa_tinggi` varchar(255) NOT NULL,
  `siswa_berat` varchar(255) NOT NULL,
  `siswa_anak_ke` varchar(255) NOT NULL,
  `id_prov` int(11) NOT NULL,
  `id_kab` int(11) NOT NULL,
  `id_kec` int(11) NOT NULL,
  `id_kel` int(11) DEFAULT 0,
  `siswa_alamat` text NOT NULL,
  `siswa_foto` varchar(255) NOT NULL,
  `siswa_noreg` varchar(255) DEFAULT NULL,
  `siswa_tgl_daftar` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_siswa` (`siswa_id`, `user_id`, `siswa_nama`, `siswa_nik`, `siswa_jekel`, `siswa_agama`, `siswa_tempat_lahir`, `siswa_tgl_lahir`, `siswa_tinggi`, `siswa_berat`, `siswa_anak_ke`, `id_prov`, `id_kab`, `id_kec`, `id_kel`, `siswa_alamat`, `siswa_foto`, `siswa_noreg`, `siswa_tgl_daftar`) VALUES
(1, 1, 'budi', '123131', 'Laki Laki', 'Islam', 'bukittinggi', '2004-12-03', '170', '80', 'anak ke 3 dari 2 saudara', 13, 1305, 130502, 0, 'padang', '20201128102212-31156.jpg', '0001', '2020-11-28 10:24:30'),
(3, 2, 'Quis velit officiis', 'Sunt vel voluptate p', 'Laki Laki', 'Hindu', 'Adipisicing suscipit', '1996-03-02', '24', '7', 'Optio fugit dolor ', 18, 1803, 180303, 0, 'Est ad pariatur Qui', '20201128112815-77820.jpg', '0002', '2020-11-28 11:35:53');
...
CREATE TABLE `tb_user` (
  ...
  `user_no_telp` varchar(255) NOT NULL,
  `user_password` varchar(255) NOT NULL,
  `user_password_repeat` varchar(255) NOT NULL,
  `user_status` varchar(255) NOT NULL,
  `user_bayar` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_user` (`user_id`, `user_nama`, `user_email`, `user_no_telp`, `user_password`, `user_password_repeat`, `user_status`, `user_bayar`) VALUES
(1, 'budi', 'budi@gmail.com', '08512312731', '$2y$10$1FVSUId87ggjGIFmkYCiMeYuSSmAkoim9T1zoIpGTDara6vt3/XNe', '123', 'Pendaftaran Selesai', 'Lunas'),
(2, 'ani', 'ani@gmail.com', '08623428', '$2y$10$4CIUqCsJDwFqTZSxZrI6P.U8cDa9u6RGJIelATOXsr2/bsVmIMuFy', '123', 'Pendaftaran Selesai', 'Lunas');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_wali_siswa`
--
...
CREATE TABLE `tb_wali_siswa` (
  ...
  `wali_status` varchar(255) NOT NULL,
  `wali_pendidikan` varchar(255) NOT NULL,
  `wali_notelp` varchar(255) NOT NULL,
  `wali_pekerjaan` varchar(255) NOT NULL,
  `wali_gaji` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indeks untuk tabel `osim`
--
ALTER TABLE `osim`
  ADD PRIMARY KEY (`osim_id`);
...
--
-- Indeks untuk tabel `tb_ayah_siswa`
--
ALTER TABLE `tb_ayah_siswa`
  ADD PRIMARY KEY (`ayah_id`);

--
-- Indeks untuk tabel `tb_ibu_siswa`
--
ALTER TABLE `tb_ibu_siswa`
  ADD PRIMARY KEY (`ibu_id`);

--
-- Indeks untuk tabel `tb_prestasi_siswa`
--
...
ALTER TABLE `tb_sekolah_asal`
  ADD PRIMARY KEY (`sekolah_asal_id`);
...
--
-- Indeks untuk tabel `tb_wali_siswa`
--
...
--
ALTER TABLE `galeri`
  MODIFY `id_galeri` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
-- AUTO_INCREMENT untuk tabel `osim`
--
ALTER TABLE `osim`
  MODIFY `osim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `ppid`
  MODIFY `ppid_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `profil`
  MODIFY `profil_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT untuk tabel `tb_ayah_siswa`
--
ALTER TABLE `tb_ayah_siswa`
  MODIFY `ayah_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tb_ibu_siswa`
--
ALTER TABLE `tb_ibu_siswa`
  MODIFY `ibu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tb_prestasi_siswa`
--
ALTER TABLE `tb_prestasi_siswa`
...
--
ALTER TABLE `tb_sekolah_asal`
  MODIFY `sekolah_asal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT untuk tabel `tb_wali_siswa`
--
ALTER TABLE `tb_wali_siswa`
...
--
ALTER TABLE `tenaga_kp`
  MODIFY `id_tkp` int(11) NOT NULL AUTO_INCREMENT;
